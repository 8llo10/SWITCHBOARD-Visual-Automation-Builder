...
const run=(args)=>spawnSync(process.execPath,['node_modules/prisma/build/index.js',...args],{stdio:'inherit'}).status;
...
if(process.argv.includes('--apply')){
 ...
 process.exit(run(['migrate','resolve','--applied','20260918000000_baseline'])||0);
}
