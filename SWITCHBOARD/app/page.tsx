...
export default function Landing(){return <main className="landing-page">
  ...
  <nav className="landing-nav liquid-glass"><Logo size={42}/><div className="landing-links"><a href="#platform">Platform</a><a href="#platform">Security</a><a href="#platform">Architecture</a></div><div className="nav-cta"><Link className="text-btn" href="/login">Sign in</Link><Link className="glass-btn" href="/signup">Create account</Link></div></nav>
  <section className="landing-hero">
    ...
    <div className="hero-actions"><Link href="/signup" className="primary-hero-btn">Create account <ArrowRight size={18}/></Link><Link href="/login" className="outline-hero-btn"><Play size={17}/> Sign in to console</Link></div>
